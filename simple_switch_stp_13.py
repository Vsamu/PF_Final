...
class SimpleSwitch13(simple_switch_13.SimpleSwitch13):
    ...
    def Dijkstra(self, grafo, start, end):
        ...
        if shortest_distance[end] != infinity:
            print ('El coste menor es ' + str(shortest_distance[end]))
            self.pru = str(path)
            print ('El camino es ' + str(path))
    ...
    def switch_features_handler(self, ev):
        ...
        print ('Grafo inicial {}'.format(self.grafo))
    ...
    def _packet_in_handler(self, ev):
        ...
        if eth_type == ether_types.ETH_TYPE_IP:
            ...
            print("IP_Origen "+srcip)
            print("IP_Destino "+dstip)
            #print 'paquete {}'.format(pkt)
            if protocol == in_proto.IPPROTO_ICMP:
                src_icmp = eth.src
                dst_icmp = eth.dst
                print ('Paquete ICMP')
                print 'MAC_origen_imcp {}'.format(src_icmp)
                print 'MAC_destino_imcp {}'.format(dst_icmp)
    ...
    def get_topology_data(self, ev):
        ...
        print('Id de pares de conmutadores con sus respectivos enlaces {}'.format(self.net.edges()))                    
        self.a = self.a +1  
        if self.a == 4:
        ...
        for x in range(int(len(self.grafo))):              
            ...
            for i in range(len(self.asit)):                                                    
                if self.asit[i][0] == x:                    
                    ...
                    contador = contador + 1 
        print('Grafo final {}'.format(self.grafo))
